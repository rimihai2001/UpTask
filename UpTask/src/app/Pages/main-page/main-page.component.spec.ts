...
describe('MainPageComponent', () => {
  ...
  it('Display Msg when there are no school tasks', () => {
      ...
      expect(contiainerMsg.innerHTML).toContain('Looks like you finished all your tasks for school. Do you want to add another one?');
  });
...
it('Task card should have task unfinished button', () => {
  ...
  it('Display Msg when there are no work tasks', () => {
    ...
    expect(contiainerMsg).toBeDefined();
    expect(contiainerMsg.innerHTML).toContain('Looks like you finished all your tasks for work. Do you want to add another one?');
  });
  ...
  it('Display Msg when there are no other tasks', () => {
    ...
    expect(contiainerMsg).toBeDefined();
    expect(contiainerMsg.innerHTML).toContain('Looks like you finished all your tasks for other activities. Do you want to add another one?');
  });
